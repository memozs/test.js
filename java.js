 ...
 *  Created: 2017-07-23 11:21:17 
*/ 
if (typeof domain_advanced_iframe === 'undefined') {
    var domain_advanced_iframe = 'http://www.tinywebgallery.com/blog/wp-content/plugins/advanced-iframe'; // Check if this is this is the path to the main directory of aip
}
...
if (doIt) {
  ...
  if (typeof post_message_domain === 'undefined') {
      var post_message_domain = "http://www.tinywebgallery.com"; 
  }
  ...
  if (typeof jquery_path === 'undefined') {
      var jquery_path = 'http://www.tinywebgallery.com/blog/wp-includes/js/jquery/jquery.js';
  }
